...
contract StakedToken is IERC20, Initializable, OwnableUpgradeSafe, PausableUpgradeSafe {
    ...
    function transfer(address to, uint256 value) external override validRecipient(to) whenNotPaused returns (bool) {
        ...
        _shareBalances[msg.sender] = _shareBalances[msg.sender].sub(shareValue, "transfer amount exceed account balance");
    ...
    function transferFrom(
        ...
        _allowedTokens[from][msg.sender] = _allowedTokens[from][msg.sender].sub(value, "transfer amount exceeds allowance");
