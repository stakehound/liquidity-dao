from tests.conftest import stakehound
...
class StakehoundGeyserMock:
    def __init__(self, key):
        ...
        self.logic = LinearLogic(
            {"x": 0, "y": stakehound_config.startMultiplier},
            {"x": days(7 * 8), "y": stakehound_config.endMultiplier,},
        )
    ...
    def getLastUpdate(self, user):
        ...
        if not self.users[user].lastUpdate:
            return stakehound_config.globalStartTime
